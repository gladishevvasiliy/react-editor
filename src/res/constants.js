...
export const PITCH = [
  ...
  { value: 19, label: 'Соль с доп. пометой Ут' },
  { value: 20, label: 'Соль с доп. пометой Ре' },
  { value: 21, label: 'Соль с доп. пометой Ми' },
  { value: 22, label: 'Соль с доп. пометой Фа' },
  { value: 23, label: 'Ми с доп. пометой Ут' },
  { value: 24, label: 'Ми с доп. пометой Ре' },
  { value: 25, label: 'Фа с доп. пометой Ут' },
  { value: 26, label: 'Фа с доп. пометой Ре' },
  { value: 27, label: 'Фа с доп. пометой Ми' },
  { value: 28, label: 'Ля с доп. пометой Ми' },
]
