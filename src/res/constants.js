...
export const PITCH = [
  ...
  { value: 4, label: 'Ут' },
  { value: 5, label: 'Ре' },
  { value: 6, label: 'Ре с доп. пометой Ут' },
  { value: 7, label: 'Ми' },
  { value: 8, label: 'Ми с доп. пометой Ре' },
  { value: 9, label: 'Фа с доп. пометой Ми' },
  { value: 10, label: 'Фа' },
  { value: 11, label: 'Соль' },
  { value: 12, label: 'Соль с доп. пометой Фа' },
  { value: 13, label: 'Ля с доп. пометой Соль' },
  { value: 14, label: 'Ля' },
  { value: 15, label: 'Фа высокое с доп. пометой Ля' },
  { value: 16, label: 'Фа высокое' },
  { value: 17, label: 'Соль высокое с доп. пометой Ля высокое' },
  { value: 18, label: 'Соль высокое' },
  { value: 19, label: 'Ля высокое' },
  { value: 20, label: 'Гораздо высоко' },
  { value: 21, label: 'Крыжик' },
]
